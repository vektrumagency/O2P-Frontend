              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1">
                  <div className="flex items-center" style={{ border: '1.5px solid rgba(0,0,0,0.25)', borderRadius: '999px' }}>
                    ...
                    <span style={{ padding: '2px 4px', fontFamily: 'var(--font-secondary)', fontWeight: 700, fontSize: '0.85rem', minWidth: 20, textAlign: 'center' }}>{item.quantity}</span>
                    <button onClick={() => updateQty(item.id, item.quantity + 1)} className="hover:opacity-50 transition-opacity" style={{ padding: '2px 10px', fontFamily: 'var(--font-secondary)', fontWeight: 700 }}>+</button>
                  </div>
                  <span style={{ fontFamily: 'var(--font-secondary)', fontWeight: 700, fontSize: '0.85rem', opacity: 0.6 }} dangerouslySetInnerHTML={{ __html: item.price }} />
        ...
        {items.length > 0 && (
          <div className="cart-pad-footer flex-shrink-0" style={{ paddingTop: '20px', paddingBottom: '64px', borderTop: '1px solid rgba(0,0,0,0.1)' }}>
            ...
            <Link
              ...
              style={{ backgroundColor: '#0a0a0a', color: '#FFE394', fontFamily: 'var(--font-secondary)', fontWeight: 700, fontSize: '1rem', padding: '14px 24px', borderRadius: '999px' }}
            >
              Finalizar Compra
            </Link>
            <Link
